        ...
        <div class="col-md-12">
          <div class="box box-default">
            <div class="box-header with-border">
              <h3 class="box-title">小学</h3>
            </div>
            <div class="box-body">
              <div class="box-body " id="inputchoose" >
                <form class="form-horizontal" id="add_form">
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="1">名称</label>
                    <div class="col-sm-3">
                      <input type="text" class="form-control" name="PSName" id="1" placeholder="请输入名称" >
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="2" class="col-sm-2 control-label">地址</label>
                    <div class="col-sm-3">
                      <input type="text" class="form-control" name="PSAddress" id="2" placeholder="请输入地址" >
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="3" class="col-sm-2 control-label">教职工数量</label>
                    <div class="col-sm-3">
                      <input type="text" class="form-control" name="PSStuffs" id="3" placeholder="请输入教职工" >
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="4" class="col-sm-2 control-label">专职老师数量</label>
                    <div class="col-sm-3">
                      <input type="text" class="form-control" name="PSTeachers" id="4" placeholder="请输入专职老师数量" >
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="5" class="col-sm-2 control-label">学生总人数</label>
                    <div class="col-sm-3">
                      <input type="text" class="form-control" name="PSCapacity" id="5" placeholder="请输入学生总人数" >
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="6" class="col-sm-2 control-label">年招生人数</label>
                    <div class="col-sm-3">
                      <input type="text" class="form-control" name="PSCapacityYears" id="6" placeholder="请输入年招生人数" >
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="7" class="col-sm-2 control-label">机构描述</label>
                    <div class="col-sm-5">
                      <textarea class="form-control" name="PSDescription" rows="4" placeholder="请输入相关描述" style="resize: none;" form="add_form" id="7"></textarea>
                    </div>
                  </div>
                  <!-- 隐藏 -->
                  ...
                  <div class="form-group" >
                    ...
                    <div class="col-sm-3">
                      <input type="text" class="form-control" id="8" placeholder="请输入坐标点X" value="0" name="PSPointX">
                    </div>
                  </div>
                  <div class="form-group" >
                    <label for="9" class="col-sm-2 control-label">点坐标Y</label>
                    <div class="col-sm-3">
                      <input type="text" class="form-control" id="9" placeholder="请输入坐标点Y" value="0" name="PSPointY">
                    </div>
                  </div>
                  <!-- 隐藏结束 -->
                  <div class="form-group">
                    <button type="button" class="btn btn-info col-xs-offset-2" style="margin-top: 20px;" id="submitBtn">
                      ...
                      提交</button>
                    <button type="button" class="btn btn-info col-xs-offset-1" style="margin-top: 20px;" onclick=to("adPInfo")>
                      <!-- <a href="adKInfo.html"></a> -->
                      返回</button>
...
<script>
  ...
  $('#submitBtn').click(function () {
    ...
    $.ajax({
      url:"${pageContext.request.contextPath}/addPrimarySchool",
      type:"POST",
      data:formData,
      processData:false,
      contentType:false,
      success:function (result) {
        if (result == "success"){
          ...
          window.location.href = "${pageContext.request.contextPath}/to/adPInfo";
        }else{
